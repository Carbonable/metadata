...
mod Component {
    ...
    impl ComponentImpl of IComponent<ContractState> {
        ...
        fn render(self: @ContractState, args: Option<Span<felt252>>) -> Array<felt252> {
            ...
            data.append('id=\\"SDG14\\" xmlns=\\"ht');
            data.append('tp://www.w3.org/2000/svg\\" vie');
            data.append('wBox=\\"0 0 62.06 62.06\\"><rec');
            data.append('t fill=\\"#007dbb\\" width=\\"6');
            data.append('2.06\\" height=\\"62.06\\"/><g');
            data.append(' fill=\\"#fff\\"><path d=\\"M5.3');
            data.append('2,7.73a8.3,8.3,0,0,1-.93.37c-.4');
            data.append('1.14-.67.23-.78.28V6.7a9.28,9.2');
            data.append('8,0,0,0,1.21-.59,4.26,4.26,0,0,');
            data.append('0,1-.71H7.59V17.23H5.32Z\\"/><p');
            data.append('ath d=\\"M12.14,14.43H8.58V12.6');
            data.append('4L11.66,5.4h2.53v7.32h1.18v1.71');
            data.append('H14.19v2.8h-2Zm0-1.71v-5l-1.79,');
            data.append('5Z\\"/><path d=\\"M19.83,9.91V5');
            data.append('.39h.83v4h1.1v.57Z\\"/><path d=');
            data.append('\\"M22,9.91V5.39h.81V9.91Z\\"/>');
            data.append('<path d=\\"M23.36,9.91V5.39h1.8');
            data.append('6V6h-1V7.28H25v.57h-.84V9.91Z\\');
            data.append('"/><path d=\\"M25.49,9.91V5.39h');
            data.append('1.9V6H26.31v1.3h.85v.58h-.85V9.');
            data.append('34H27.4v.57Z\\"/><path d=\\"M19');
            data.append('.83,17.3V12.78H21a2.92,2.92,0,0');
            data.append(',1,.54.05,1.15,1.15,0,0,1,.42.1');
            data.append('9.82.82,0,0,1,.27.36,1.49,1.49,');
            data.append('0,0,1,.09.56,1.33,1.33,0,0,1-.0');
            data.append('7.47.7.7,0,0,1-.22.31.73.73,0,0');
            data.append(',1-.36.15,1,1,0,0,1,.44.19.89.8');
            data.append('9,0,0,1,.26.37,1.51,1.51,0,0,1,');
            data.append('.09.55,2,2,0,0,1-.08.58,1.27,1.');
            data.append('27,0,0,1-.24.41,1.09,1.09,0,0,1');
            data.append('-.4.25,1.55,1.55,0,0,1-.55.08Zm');
            data.append('.83-2.67h.28a.8.8,0,0,0,.38-.08');
            data.append('.38.38,0,0,0,.19-.22,1.35,1.35,');
            data.append('0,0,0,0-.38.75.75,0,0,0-.08-.37');
            data.append('.43.43,0,0,0-.24-.18,1.61,1.61,');
            data.append('0,0,0-.42-.05h-.16Zm0,2.09H21a.');
            data.append('6.6,0,0,0,.51-.18.94.94,0,0,0,.');
            data.append('14-.56,1.31,1.31,0,0,0-.07-.44.');
            data.append('46.46,0,0,0-.21-.26A.87.87,0,0,');
            data.append('0,21,15.2h-.29Z\\"/><path d=\\"');
            data.append('M22.78,17.3V12.78h1.9v.58H23.6v');
            data.append('1.3h.85v.58H23.6v1.49h1.09v.57Z');
            data.append('\\"/><path d=\\"M25,17.3V12.78h');
            data.append('.83v4h1.09v.57Z\\"/><path d=\\"');
            data.append('M28.36,17.36a1.54,1.54,0,0,1-.7');
            data.append('7-.17,1,1,0,0,1-.41-.52,2.34,2.');
            data.append('34,0,0,1-.12-.79V14.19a2.3,2.3,');
            data.append('0,0,1,.12-.79,1,1,0,0,1,.41-.5,');
            data.append('1.54,1.54,0,0,1,.77-.17,1.52,1.');
            data.append('52,0,0,1,.77.17,1,1,0,0,1,.41.5');
            data.append(',2.3,2.3,0,0,1,.12.79v1.69a2.3,');
            data.append('2.3,0,0,1-.12.79,1,1,0,0,1-.41.');
            data.append('51A1.42,1.42,0,0,1,28.36,17.36Z');
            data.append('m0-.6a.41.41,0,0,0,.3-.09.43.43');
            data.append(',0,0,0,.13-.25,1.22,1.22,0,0,0,');
            data.append('0-.34V14a1.18,1.18,0,0,0,0-.34.');
            data.append('41.41,0,0,0-.13-.24.41.41,0,0,0');
            data.append('-.3-.09.45.45,0,0,0-.3.09.41.41');
            data.append(',0,0,0-.13.24,1.18,1.18,0,0,0,0');
            data.append(',.34v2.08a1.79,1.79,0,0,0,0,.34');
            data.append('.44.44,0,0,0,.14.25A.41.41,0,0,');
            data.append('0,28.36,16.76Z\\"/><path d=\\"M');
            data.append('30.58,17.3l-.64-4.52h.69L31,15.');
            data.append('71l.47-2.92H32l.48,2.92.37-2.93');
            data.append('h.68l-.63,4.52h-.67l-.51-3-.49,');
            data.append('3Z\\"/><path d=\\"M35.57,17.3l-');
            data.append('.64-4.52h.69L36,15.71l.47-2.92H');
            data.append('37l.48,2.92.37-2.93h.68l-.63,4.');
            data.append('52h-.67l-.51-3-.49,3Z\\"/><path');
            data.append(' d=\\"M38.53,17.3l.91-4.52h.88l');
            data.append('.91,4.52h-.77l-.18-1h-.79l-.18,');
            data.append('1Zm1-1.57h.61l-.3-1.9Z\\"/><pat');
            data.append('h d=\\"M41.75,17.3V13.39H41v-.6');
            data.append('1h2.26v.61h-.71V17.3Z\\"/><path');
