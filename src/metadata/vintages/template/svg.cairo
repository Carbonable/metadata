use metadata::metadata::vintages::models::CPV3TemplateData as Data;
use metadata::metadata::common::utils::ArrayConcat;


fn generate(data: @Data) -> Span<felt252> {
...
#[inline(always)]
fn print_head_42607(ref svg: Array<felt252>, data: @Data) {
...
#[inline(always)]
fn print_60846(ref svg: Array<felt252>, data: @Data) {
...
fn print_head_card_container(ref svg: Array<felt252>, data: @Data) {
    ...
    print_60846(ref svg, data);

    print_head_42607(ref svg, data);
